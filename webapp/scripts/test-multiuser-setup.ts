...
async function cleanDatabase() {
  ...
  try {
    ...
    const testUsers = [
      ...
      {
        email: 'supporter.tester@yopmail.com',
        name: 'Supporter Tester',
        role: 'SUPPORTER' as const,
        subscriptionEnd: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000), // 1 año
    ...
    console.log('')
    console.log('� Nuevos emails incluidos:')
    console.log('   • supporter.tester@yopmail.com (SUPPORTER) - Suscripción premium top')
    console.log('')
